...
public class SubChunkRadVector {
    ...
    /**
     * Classify a vector (source relative to apex) into one of the 6 pyramids.
     * Rule: dominant absolute axis wins; ties resolved X &gt; Y &gt; Z, positive over negative.
     * Partitions R^3 \ {apex} into 6 disjoint square pyramids whose ribs pass through
     * the corners of the corresponding subchunk face.
     */
