...
public class GeneralConfig {
    ...
    public static final ModConfigSpec.BooleanValue RADIATION_HARM_EFFECTS = BUILDER
            .comment("If true, radiation exposure applies mob effects and damage (confusion, weakness, blindness, magic damage). If false, simulation still runs and dose still accumulates, but no harmful effects are applied to entities.")
            .define("radiationHarmEffects", true);
