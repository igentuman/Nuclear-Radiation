package igentuman.nr.handler.config;
        ...
        public RadiationConf(ForgeConfigSpec.Builder builder) {
            ...
            RADIATION_REMOVAL_ITEMS = builder
                    ...
                    .define("radiation_removal_items", List.of(
                            ...
                            "nuclearradiation:dominos|250000000",
                            "nuclearradiation:moresmore|2500000000",
                            "nuclearradiation:evenmoresmore|1000000000",
                            "nuclearradiation:radaway|5000000000"
            ...
            ITEM_RADIATION = builder
                    ...
                    .define("items_radiation", List.of(
                            "nuclearradiation:spaxelhoe_thorium|50000",
            ...
            ARMOR_PROTECTION = builder
                    ...
                    .define("armor_shielding", List.of(
                            ...
                            "nuclearradiation:hazmat_mask|3",
                            "nuclearradiation:hazmat_chest|5",
                            "nuclearradiation:hazmat_pants|4",
                            "nuclearradiation:hazmat_boots|3",
                            "nuclearradiation:hev_helmet|5",
                            "nuclearradiation:hev_chest|7",
                            "nuclearradiation:hev_pants|6",
                            "nuclearradiation:hev_boots|5"
                    ), o -> o instanceof ArrayList);

            BIOME_RADIATION = builder
                    .comment("Natural radiation per biome: uRad", "Format: biome_id|radiation")
                    .define("biome_radiation", List.of("nuclearradiation:wasteland|2000", "minecraft:nether_wastes|500"), o -> o instanceof ArrayList);

            DIMENSION_RADIATION = builder
                    .comment("Natural radiation per dimension: uRad", "Format: dim_id|radiation")
                    .define("dimension_radiation", List.of("nuclearradiation:wasteland|200000", "minecraft:the_nether|1000"), o -> o instanceof ArrayList);
