...
import igentuman.nr.multiblock.fusion.FusionReactor;
...
import static igentuman.nr.setup.registration.NCBlocks.*;
import static igentuman.nr.setup.registration.NCFluids.NC_MATERIALS;
import static igentuman.nr.setup.registration.NCItems.*;
import static igentuman.nr.setup.registration.NCStorageBlocks.STORAGE_BLOCKS;
...
public class NCLanguageProvider extends LanguageProvider {
    ...
    private void labels() {
        add("nc.guide_book.name", "NuclearRadiation Guide");
        add("nc.guide_book.desc", "Basics and advanced topics about NuclearRadiation");
        ...
        add("block.nuclearradiation.glowing_mushroom", "Glowing Mushroom");
        ...
        add("container.nr.storage", "Item Storage Container");
    }
    ...
    private void tooltips() {
        ...
        add("tooltip.nr.lightning_rod_charge", "Can charge NC Energy blocks by %s FE");
        add("tooltip.nr.jei.gas_to_fluid.desc","NC blocks automatically converts Mek Gasses into Fluids during input");

        add("tooltip.nr.hev.desc","Grants additional protection and passive effects when charged");
        add("tooltip.nr.moderator.desc","Fission Reactor moderator. Has to be placed next to fuel cell. \n Each adjacent with fuel cell adds +%s%% efficiency and +%s%% heat gen");
        ...
        add("gui.nr.reactor_mode.tooltip_steam","Boiling Mode");
        add("gui.nr.reactor_mode.tooltip_energy","Energy Mode");
        add("gui.nr.reactor_mode.timer","Changing mode in: %s sec");
        ...
        add("tooltip.nr.fusion_connector.descr", "Used to connect fusion core and toroidal reactor chamber");
        add("tooltip.nr.fusion_casing.descr", "Used to build toroidal fusion reactor chamber");
        add("tooltip.nr.rf_amplifier.not_found","No RF Amplifiers attached");
        add("tooltip.nr.rf_amplifier.power","Energy Required: %s FE/t");
        add("tooltip.nr.rf_amplifier.voltage","Amplification: %s V");
        add("tooltip.nr.rf_amplifier.efficiency","Efficiency: %s%%");
        add("tooltip.nr.rf_amplifier.heat","Heat: %s H/t");
        add("tooltip.nr.rf_amplifier.max_temp","Max Temperature: %s K");

        add("tooltip.nr.reactor.charge","Charged: %s");
        add("tooltip.nr.reactor.has_magnets","Electromagnets: %s");
        add("tooltip.nr.reactor.has_amplifiers","RF Amplifiers: %s");
        add("tooltip.nr.reactor.has_coolant","Coolant: %s");
        add("tooltip.nr.reactor.has_energy","Energy: %s");
        add("tooltip.nr.reactor.has_fuel","Fuel: %s");
        add("tooltip.nr.reactor.ready","Ready");
        add("tooltip.nr.reactor.not_ready","Not Ready");
        add("tooltip.nr.show_recipes","Show Recipes");
        add("gui.nr.fluid_tank_renderer.can_void","SHIFT+Mouse 1 to void content");

        add("tooltip.nr.electromagnet.not_found","No Electromagnets attached");
        add("tooltip.nr.electromagnet.power","Energy Required: %s FE/t");
        add("tooltip.nr.electromagnet.magnetic_field","Magnetic Field: %s T");
        add("tooltip.nr.description.efficiency","Efficiency: %s%%");
        add("tooltip.nr.description.expansion","Expansion: %s%%");
        add("tooltip.nr.electromagnet.heat","Heat: %s H/t");
        add("tooltip.nr.electromagnet.max_temp","Max Temparature: %s K");
        add("tooltip.nr.blade.desc","Converts the energy of the oncoming fluid flow into rotational energy in the rotor shaft. The expansion coefficient is larger than unity, so the volume of the fluid flow will increase each time it passes through a set. Must be placed in complete sets of four coplanar groups extending from the turbine shaft to the wall. Each blade block can process up to %s of oncoming fluid.");
        add("tooltip.nr.rotor_shaft.desc","Connects the rotor blades to the dynamo to convert the generated kinetic energy into electrical energy. Must be placed axially as a cuboid along the centre of the turbine interior.");
        add("tooltip.nr.bearing.desc","Connects the rotor shaft to the turbine wall and dynamo. Must cover the full area of each end of the shaft.");
        add("turbine.active.coils", "Active coils: %s");
        add("turbine.blades.flow", "Max steam flow: %s mB/t");
        add("tooltip.nr.liquid_empty","Stored: 0 of %s");
        add("tooltip.nr.liquid_stored","Stored: %s %s / %s");
        add("tooltip.nr.liquid_capacity","Capacity: %s");
        ...
        add("amount","Amount: %s");
        add("sound_event.nuclearradiation.item.charged","Item Charged");
        add("tooltip.nr.analyzed","Item analyze completed");
        add("tooltip.nr.shielding.desc","Combine with armor in crafting grid");
        add("tooltip.nr.rad_shielding","Rad Shielding LVL: %s");
        add("tooltip.nr.use_in_leacher","Item can be used in Leacher");
        add("tooltip.nr.energy_stored","Energy Stored: %s / %s");
        add("tooltip.nr.energy_capacity","Energy Capacity: %s");
        ...
        add("message.nr.battery.side_config","Mode: %s");
        add("message.nr.barrel.side_config","Mode: %s");
        add("gui.nr.reactor_comparator_config.tooltip_1","Comparator: Energy Stored");
        add("gui.nr.reactor_comparator_config.tooltip_2","Comparator: Heat Stored");
        add("gui.nr.reactor_comparator_config.tooltip_3","Comparator: Depletion Progress");
        add("gui.nr.reactor_comparator_config.tooltip_4","Comparator: Fuel Left");
        add("gui.nr.reactor_comparator_config.tooltip_5","Input: On/Off Reactor");
        add("gui.nr.reactor_comparator_config.tooltip_6","Input: Moderation Control");
        add("gui.nr.reactor_comparator_config.tooltip_11","Comparator: Energy Stored");
        add("gui.nr.reactor_comparator_config.tooltip_12","Comparator: Heat Stored");
        add("gui.nr.reactor_comparator_config.tooltip_13","Comparator: Efficiency");
        add("gui.nr.reactor_comparator_strength.tooltip","Current Signal Strength: %s");
        add("gui.nr.redstone_config.tooltip_0","WORK MODE: IGNORE SIGNAL");
        add("gui.nr.redstone_config.tooltip_1","WORK MODE: ON SIGNAL");
        add("gui.nr.fluid_tank_renderer.amount_capacity","%s/%s mB");
        add("gui.nr.fluid_tank_renderer.amount","%s mB");
        add("fuel.forge_energy.descr","Forge Energy: %s FE/t");
        add("rtg.fe_generation","Energy Generation: %s FE/t");
        add("tooltip.nr.shift_rbm_to_change","Sneak+Use to change");
        add("tooltip.nr.qnp_mode","Mode: %s");
        ...
        add("tooltip.nr.chunk_position","Chunk Position: %s");
        ...
        add("tooltip.nr.content_saved","Content Saved");
        ...
        add("tooltip.nr.reactor.plasma_heat", "Plasma Heat: %s K");
        add("tooltip.nr.reactor.plasma_optimal", "Optimal: %s K");
        ...
        add("tooltip.nr.use_multitool", "Use Multitool to config sides");
        add("tooltip.nr.multitool.desc", "Commonly used to config sides of batteries, barrels, ports...");
        add("tooltip.nr.multitool.shift.desc", "Sneak + RBM to config back side");
        ...
        add("gui.nr.side_config.tooltip", "Side Config");
