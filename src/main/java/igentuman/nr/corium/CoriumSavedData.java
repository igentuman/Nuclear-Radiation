...
/**
 * Persists live corium fluid positions per dimension, each mapped to a water-contact
 * cooling count, so meltdown hazard state (melting, burning, quenching, solidifying)
 * survives restarts. Kept in sync by {@link CoriumFluidBlock}.
 */
