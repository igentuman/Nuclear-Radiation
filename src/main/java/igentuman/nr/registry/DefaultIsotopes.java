...
import igentuman.nr.api.isotope.IsotopeBuilder;
...
public final class DefaultIsotopes {
    ...
    public static List<IChunkRadiation.IsotopeDefinition> defaults() {
        List<IChunkRadiation.IsotopeDefinition> list = new ArrayList<>();

        list.add(IChunkRadiation.IsotopeDefinition.create(PA_91)
                .alpha(0.95f).beta(0.0f).xray(0.85f).neutron(0.8f)
                .halfLife(saturate(32760.0 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(U_238)
                .alpha(0.95f).beta(0.0f).xray(0.05f).neutron(0.0f)
                .halfLife(saturate(4.468e9 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(U_235)
                .alpha(0.85f).beta(0.0f).xray(0.15f).neutron(0.0f)
                .halfLife(saturate(7.04e8 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(PU_239)
                .alpha(0.95f).beta(0.0f).xray(0.05f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(PA_233)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(RU_106)
                .alpha(0.01f).beta(0.9f).xray(0.4f).neutron(0.01f)
                .halfLife(saturate(371.8 * TICKS_PER_DAY))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(PM_147)
                .alpha(0.01f).beta(0.9f).xray(0.4f).neutron(0.01f)
                .halfLife(saturate(2.62 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(EU_155)
                .alpha(0.01f).beta(0.9f).xray(0.4f).neutron(0.01f)
                .halfLife(saturate(4.76 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(CS_137)
                .alpha(0.0f).beta(0.7f).xray(0.3f).neutron(0.0f)
                .halfLife(saturate(30.17 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(CS_55)
                .alpha(0.0f).beta(0.7f).xray(0.3f).neutron(0.01f)
                .halfLife(saturate(30.04 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(I_131)
                .alpha(0.0f).beta(0.6f).xray(0.4f).neutron(0.0f)
                .halfLife(saturate(8.02 * TICKS_PER_DAY))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(SR_90)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(NP_236)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(NP_237)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(PU_238)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(PU_240)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(PU_241)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(PU_242)
                .alpha(0.94f).beta(0.0f).xray(0.03f).neutron(0.03f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(AM_241)
                .alpha(0.90f).beta(0.0f).xray(0.10f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(AM_242)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(AM_243)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CM_243)
                .alpha(0.90f).beta(0.0f).xray(0.10f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CM_245)
                .alpha(0.90f).beta(0.0f).xray(0.10f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CM_246)
                .alpha(0.93f).beta(0.0f).xray(0.02f).neutron(0.05f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CM_247)
                .alpha(0.90f).beta(0.0f).xray(0.10f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(BK_247)
                .alpha(0.93f).beta(0.0f).xray(0.07f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(BK_248)
                .alpha(0.90f).beta(0.0f).xray(0.10f).neutron(0.0f)
                .halfLife(saturate(300.0 * TICKS_PER_YEAR))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(CF_249)
                .alpha(0.85f).beta(0.0f).xray(0.15f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CF_250)
                .alpha(0.93f).beta(0.0f).xray(0.02f).neutron(0.05f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CF_251)
                .alpha(0.95f).beta(0.0f).xray(0.05f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(NA_22)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CA_48)
                .alpha(0.0f).beta(1.0f).xray(0.0f).neutron(0.0f)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(BE_7)
                .alpha(0.0f).beta(0.0f).xray(1.0f).neutron(0.0f)
                .halfLife(saturate(53.22 * TICKS_PER_DAY))
                .quality(1.0f, 1.0f, 20.0f, 10.0f)
                .build());

        list.add(IChunkRadiation.IsotopeDefinition.create(IR_192)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(CN_291)
        ...
        list.add(IChunkRadiation.IsotopeDefinition.create(AC_225)
                .alpha(0.95f).beta(0.0f).xray(0.05f).neutron(0.0f)
    ...
    public static void registerDefaults() {
        for (IChunkRadiation.IsotopeDefinition def : defaults()) {
            apply(def);
        }
    }

    public static void apply(IChunkRadiation.IsotopeDefinition def) {
